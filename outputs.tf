...
output "domain_name" {
  value = var.custom_domain == null ? substr(aws_api_gateway_deployment.api-deployment.invoke_url, 0, length(aws_api_gateway_deployment.api-deployment.invoke_url - length(var.stage_name) - 1)) : module.custom_domain.domain_name
